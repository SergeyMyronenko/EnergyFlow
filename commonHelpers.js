import{L as f,i as l,g as m,c as h,u as y}from"./assets/modals-functions-ad9a9335.js";import"./assets/vendor-8cce9181.js";let g,v;const u=6;window.location.pathname==="/page-2.html"&&(g=document.querySelector(".favorites-list"),v=document.querySelectorAll(".favorites-pagination-block button"),p(1),v.forEach(t=>{t.addEventListener("click",()=>{const e=parseInt(t.textContent);p(e)})}));function p(t){const e=(t-1)*u,r=e+u;g.querySelectorAll(".favorites-list-item").forEach((a,s)=>{s>=e&&s<r?a.style.display="block":a.style.display="none"}),v.forEach(a=>{parseInt(a.textContent)===t?a.classList.add("active-btn"):a.classList.remove("active-btn")})}function b(t){const e=JSON.parse(localStorage.getItem(f)),r=JSON.stringify(e.filter(o=>o._id!==t));localStorage.setItem(f,r)}function x(t){t.style.animation="opacity-animation 1s ease-out",setTimeout(()=>{t.style.transform="translateX(-200%)"},100),setTimeout(()=>{t.style.position="absolute",t.style.top="0px",t.style.left="0px"},450),setTimeout(()=>t.remove(),1e3)}function w(t){const e=document.querySelector(`[data-id="${t}"]`).parentElement.parentElement.parentElement;x(e)}document.querySelector(".favorites-contanier-block");window.location.pathname==="/favorites.html"&&favoritesWotkoutContainer.addEventListener("click",t=>{if(t.target.classList.contains("favorites-icon-svg")){const e=t.target.dataset.id;b(e),w(e)}});const L="/EnergyFlow/assets/dumbbell-eb25f45b.png";function k(){const t=JSON.parse(localStorage.getItem("favoriteData"))||[],e=document.querySelector(".favorites-contanier-block"),r=document.querySelector(".pagination-mobile-list");e.innerHTML="",t.length===0&&(e.innerHTML=`<img class="message-info-svg" src="${L}" alt="dumbbell" />
