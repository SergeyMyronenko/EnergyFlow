import{o as z,a as D,i as L}from"./assets/modals-functions-6aafa95d.js";import{a as c}from"./assets/vendor-8cce9181.js";const _=/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/,N="feedback-form-state",f=document.querySelector(".footer-subscription"),C=f.querySelector(".input-footer"),P=document.querySelector(".footer-button"),U=async e=>{try{return(await c.post("https://energyflow.b.goit.study/api/subscription",{email:e})).data}catch(t){throw new Error(t.message)}},F=async e=>{e.preventDefault(),P.blur();const t=C.value.trim();if(!_.test(t))z("Enter a valid email!");else{try{await U(t),D("Successful subscription!")}catch{z("There is already a user with this email!")}localStorage.removeItem(N),f.reset()}};f.addEventListener("submit",F);f.addEventListener("input",e=>{const t=C.value.trim(),s=JSON.stringify({footerEmail:t});localStorage.setItem(N,s)});c.defaults.baseURL="https://energyflow.b.goit.study/api";const E=document.querySelector(".exersizes-cards-container"),o=document.querySelector(".exersizes-cards-container-wrapper"),k=document.querySelector(".exersizes-result-card-container"),p=document.querySelector(".exersizes-result-card-container-wrapper"),d=document.querySelector(".exersizes-message-container"),j=document.querySelector(".exersizes-pagination-container"),I=document.querySelector(".exersizes-input-container"),a=document.querySelector(".exersizes-input-btn"),J=document.querySelector(".exersizes-input-btn-s"),T=document.querySelector(".dash"),g=document.querySelector(".exercise-name"),O=1,G=document.querySelector(".exersizes-list");document.querySelector(".exersizes-pagination-list");document.querySelector(".exersizes-pagination-btn");K();document.addEventListener("DOMContentLoaded",A());G.addEventListener("click",e=>{if(e.preventDefault(),e.target.nodeName==="BUTTON"){{u();const t=e.target.textContent.trim();sessionStorage.clear(),sessionStorage.setItem("filterType",JSON.stringify(t)),A(t),S(),Q(),re(),X(e)}v()}});o.addEventListener("click",$);function $(e){if(e.preventDefault(),u(),e.target.nodeName!=="DIV"&&e.target.nodeName!=="H3"&&e.target.nodeName!=="P")return;u();const t=e.target.dataset.filter,s=e.target.dataset.target;M(t,s,O),S(),Y(e),ee(),v(),sessionStorage.setItem("filterSubType",JSON.stringify(s)),sessionStorage.setItem("filterType",JSON.stringify(t))}j.addEventListener("click",e=>{if(e.preventDefault(),e.target.nodeName==="BUTTON"){{u();const t=JSON.parse(sessionStorage.getItem("filterType")),s=e.target.textContent.trim();let r;sessionStorage.getItem("filterSubType")&&(r=JSON.parse(sessionStorage.getItem("filterSubType"))),S(),V(t,r,s),Z(e)}v()}});async function A(e,t,s){const r=await c.get("/filters",{params:h(e,t,s)});try{if(r.data.results.length===0)throw new Error("No results found...");e=r.data.results[0].filter,B(r),b(r)}catch{y()}}async function M(e,t,s){const r=await c.get("/exercises",{params:h(e,t,s)});try{if(r.data.results.length===0)throw new Error("No results found...");H(r),s===1&&b(r)}catch{y()}}async function W(e,t,s){const r=await c.get("/filters",{params:h(e,t,s)});try{if(r.data.results.length===0)throw new Error("No results found...");e=r.data.results[0].filter,B(r)}catch{y()}}async function V(e,t,s){t?await M(e,t,s):await W(e,t,s)}async function x(e){if(e.target.nodeName!=="BUTTON"&&e.keyCode!==13)return;u();const t=document.querySelector(".exersizes-input").value.trim().toLowerCase(),s=JSON.parse(sessionStorage.getItem("filterType")),r=JSON.parse(sessionStorage.getItem("filterSubType"));try{if(t.length!==0){const n=await c.get("/exercises",{params:h(s,r,O,t)});if(n.data.results.length===0)throw new Error("No results found...");H(n),b(n)}}catch{y()}l(),v()}async function B(e){const t=e.data.results;o.classList.remove("hidden"),p.classList.add("hidden"),d.classList.add("hidden"),E.innerHTML="";const s=t.map(r=>{const n=r.filter,i=r.name;return`<li class="first-filter"><div class="exersizes-card-bytype" tabindex="0" style="background: linear-gradient(
    0deg,
    rgba(16, 16, 16, 0.7) 0%,
...
<svg class="exersizes-card-title-icon" width="24" height="24" aria-label="Runner icon">
    ...
    <div class="just-wrapper">
     ...
     <button class="exersizes-pagination-btn"
              ...
              </li>`;r.insertAdjacentHTML("beforeend",s)}function Z(e){e.target.textContent.trim();const t=document.querySelector(".exersizes-pagination-item-active"),s=e.target;t.classList.remove("exersizes-pagination-item-active"),s.classList.add("exersizes-pagination-item-active")}function K(){window.scrollY>120?document.querySelector(".up-link").classList.add("show"):document.querySelector(".up-link").classList.remove("show")}function ee(){const e=document.querySelector(".exersizes-input");I.classList.remove("hidden"),e.addEventListener("keyup",te),J.addEventListener("click",x)}function te(e){a.classList.remove("hidden"),e.target.value.trim().length>0&&(a.classList.remove("hidden"),a.addEventListener("click",l)),e.keyCode===13&&(x(e),l(),a.classList.add("hidden"))}function se(){a.classList.remove("hidden");const e=t=>{t.preventDefault(),l(),a.classList.add("hidden")};a.addEventListener("click",e)}function re(){const e=document.querySelector(".exersizes-input");e.removeEventListener("input",se),e.removeEventListener("click",x),I.classList.add("hidden"),a.classList.add("hidden")}function l(){const e=document.querySelector(".exersizes-input");e.value="",a.classList.add("hidden"),a.removeEventListener("click",l)}function u(){document.querySelector(".exersizes-header-filter-cont").insertAdjacentHTML("afterbegin",'<span class="loader"></span>')}function v(){document.querySelector(".loader").remove()}function S(){const t=document.querySelector(".exersizes-container").getBoundingClientRect().y;window.scrollBy({top:t,behavior:"smooth"})}function ne(){const e=document.querySelector(".footer-policy"),t=document.querySelector(".footer-service"),s=document.querySelector(".modal-overlay"),r=document.querySelector(".policy-modal-overlay");e.addEventListener("click",()=>r.classList.add("is-open")),t.addEventListener("click",()=>s.classList.add("is-open")),r.addEventListener("click",()=>r.classList.remove("is-open")),s.addEventListener("click",()=>s.classList.remove("is-open"))}const R=window.location.pathname,ie=R.lastIndexOf("/"),q=R.substring(ie);(q==="/index.html"||q==="/")&&ne();
