import{o as z,a as D,i as x}from"./assets/modals-functions-5fd078b8.js";import{a as d}from"./assets/vendor-8cce9181.js";const P=/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/,N="feedback-form-state",y=document.querySelector(".footer-subscription"),T=y.querySelector(".input-footer"),_=document.querySelector(".footer-button"),F=async e=>{try{return(await d.post("https://energyflow.b.goit.study/api/subscription",{email:e})).data}catch(t){throw new Error(t.message)}},U=async e=>{e.preventDefault(),_.blur();const t=T.value.trim();if(!P.test(t))z("Enter a valid email!");else{try{await F(t),D("Successful subscription!")}catch{z("There is already a user with this email!")}localStorage.removeItem(N),y.reset()}};y.addEventListener("submit",U);y.addEventListener("input",e=>{const t=T.value.trim(),s=JSON.stringify({footerEmail:t});localStorage.setItem(N,s)});d.defaults.baseURL="https://energyflow.b.goit.study/api";const k=document.querySelector(".exersizes-cards-container"),o=document.querySelector(".exersizes-cards-container-wrapper"),q=document.querySelector(".exersizes-result-card-container"),f=document.querySelector(".exersizes-result-card-container-wrapper"),u=document.querySelector(".exersizes-message-container"),j=document.querySelector(".exersizes-pagination-container"),I=document.querySelector(".exersizes-input-container"),a=document.querySelector(".exersizes-input-btn"),J=document.querySelector(".exersizes-input-btn-s"),A=document.querySelector(".dash"),g=document.querySelector(".exercise-name"),B=1,G=document.querySelector(".exersizes-list");document.querySelector(".exersizes-pagination-list");document.querySelector(".exersizes-pagination-btn");document.addEventListener("scroll",se);document.addEventListener("DOMContentLoaded",O());G.addEventListener("click",W);async function W(e){if(e.preventDefault(),e.target.nodeName==="BUTTON")try{v();const t=e.target.textContent.trim();sessionStorage.clear(),sessionStorage.setItem("filterType",JSON.stringify(t)),O(t),w(),ee(),ae(),Z(e)}catch(t){console.log(t),c()}finally{L()}}o.addEventListener("click",Y);async function Y(e){if(e.preventDefault(),!(e.target.nodeName!=="DIV"&&e.target.nodeName!=="H3"&&e.target.nodeName!=="P")){let t;e.pageY<1200?t=50:e.pageY>1200&&e.pageY<2e3||window.innerWidth>1440?t=250:t=500;const s=e.target.dataset.filter,n=e.target.dataset.target;try{v(),w(),setTimeout(()=>{$(s,n,B),K(e),ne(),sessionStorage.setItem("filterSubType",JSON.stringify(n)),sessionStorage.setItem("filterType",JSON.stringify(s))},t)}catch{c()}finally{L()}}}j.addEventListener("click",V);async function V(e){if(e.preventDefault(),e.target.nodeName==="BUTTON")try{const t=JSON.parse(sessionStorage.getItem("filterType")),s=e.target.textContent.trim();let n;v(),sessionStorage.getItem("filterSubType")&&(n=JSON.parse(sessionStorage.getItem("filterSubType"))),w(),Q(t,n,s),te(e)}catch{c()}finally{L()}}async function O(e,t,s){const n=await d.get("/filters",{params:h(e,t,s)});try{if(n.data.results.length===0)throw new Error("No results found...");e=n.data.results[0].filter,M(n),b(n)}catch{c()}}async function $(e,t,s){const n=await d.get("/exercises",{params:h(e,t,s)});try{if(n.data.results.length===0)throw new Error("No results found...");H(n),s===1&&b(n)}catch{c()}}async function X(e,t,s){const n=await d.get("/filters",{params:h(e,t,s)});try{if(n.data.results.length===0)throw new Error("No results found...");e=n.data.results[0].filter,M(n)}catch{c()}}async function Q(e,t,s){t?(await $(e,t,s),document.querySelectorAll(".second-filter").forEach(r=>{r.classList.remove("animation")})):await X(e,t,s)}async function S(e){if(e.target.nodeName!=="BUTTON"&&e.keyCode!==13)return;const t=document.querySelector(".exersizes-input").value.trim().toLowerCase(),s=JSON.parse(sessionStorage.getItem("filterType")),n=JSON.parse(sessionStorage.getItem("filterSubType"));try{if(v(),t.length!==0){const r=await d.get("/exercises",{params:h(s,n,B,t)});if(r.data.results.length===0)throw new Error("No results found...");H(r),b(r)}}catch{c()}finally{m(),L()}}async function M(e){const t=e.data.results;o.classList.remove("hidden"),f.classList.add("hidden"),u.classList.add("hidden"),k.innerHTML="";const s=t.map(r=>{const i=r.filter,l=r.name;return`<li class="first-filter"><div class="exersizes-card-bytype" tabindex="0" style="background: linear-gradient(
    0deg,
    rgba(16, 16, 16, 0.7) 0%,
